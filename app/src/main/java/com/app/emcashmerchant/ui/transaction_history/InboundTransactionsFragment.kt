 ...
 * Use the [InboundTransactionsFragment.newInstance] factory method to
...
class InboundTransactionsFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment InboundTransactionsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            InboundTransactionsFragment().apply {
