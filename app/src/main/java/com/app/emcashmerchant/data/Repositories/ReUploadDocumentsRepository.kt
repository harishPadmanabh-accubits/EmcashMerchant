...
import com.app.emcashmerchant.data.model.response.ReUploadResponse
import com.app.emcashmerchant.data.model.response.ReUploadUserDeatilsResponse
...
class ReUploadDocumentsRepository(val context: Context) {
    ...
    fun reUploadUserDetails(
        ...
        api.reUploadUserDetails().awaitResponse(
            onFailure = {
                onApiCallback(false, it, null)
