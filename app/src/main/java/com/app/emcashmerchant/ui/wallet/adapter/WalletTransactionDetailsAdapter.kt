...
class WalletTransactionDetailsAdapter(val transactions: ArrayList<WalletTransactionResponse.Data.Row>) :
    RecyclerView.Adapter<WalletTransactionDetailsAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): WalletTransactionDetailsAdapter.ViewHolder {
        val view: View = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_inner_activity_details, parent, false)
        return WalletTransactionDetailsAdapter.ViewHolder(view)
    }
    ...
    override fun onBindViewHolder(
        holder: WalletTransactionDetailsAdapter.ViewHolder,
        position: Int
    ) {
