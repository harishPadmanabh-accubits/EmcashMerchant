 ...
 * Use the [OutBoundTransactionsFragment.newInstance] factory method to
...
class OutBoundTransactionsFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment OutBoundTransactionsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            OutBoundTransactionsFragment().apply {
